...
from tensorflow.keras import  Sequential , Model  , losses , metrics , optimizers , layers
...
'''
实验dropout层对模型的影响，实验5次，每次实验使用7层全连接层网络训练，
在全连接网络中间插入0~4个dropout层。
并通过adam层优化器训练500个epoch
'''
for n in range(5):
    #创建容器
    model = Sequential()
